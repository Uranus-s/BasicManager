package com.basic.service.ai.assistant.capability.dict;
...
import static com.basic.service.ai.assistant.operation.AssistantOperations.query;
import static com.basic.service.ai.assistant.operation.AssistantOperations.action;
import static com.basic.service.ai.assistant.operation.AssistantOperations.result;
...
public class DictAssistantCapability implements AssistantCapability {
    ...
    private static List<com.basic.service.ai.assistant.action.model.ActionPreviewField> fields(Object... values) { List<com.basic.service.ai.assistant.action.model.ActionPreviewField> out = new ArrayList<>(); for (int i = 0; i < values.length; i += 2) out.add(new com.basic.service.ai.assistant.action.model.ActionPreviewField(String.valueOf(values[i]), values[i + 1] == null ? "" : String.valueOf(values[i + 1]))); return List.copyOf(out); }
